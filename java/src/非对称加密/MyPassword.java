...
// 将公钥和私钥保存到Map
    ...
    /**
      ...
      */
        ...
        Map<Integer, String> keyMap = MyPassword.genKeyPair();
        String content = "DOCT20";
        System.out.println("随机生成的公钥为:" + keyMap.get(0));
        System.out.println("随机生成的私钥为:" + keyMap.get(1));
        String messageEn = MyPassword.encrypt(content, keyMap.get(0));
        System.out.println("加密后的字符串为:" + messageEn);
        String messageDe = MyPassword.decrypt(messageEn, keyMap.get(1));
